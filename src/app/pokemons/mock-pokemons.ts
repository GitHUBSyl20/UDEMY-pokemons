...
//modèle de pokemon importé depuis ./pokemon
//création d'une liste qui est ensuite mise dans une constante qui sera exporté pour etre utilisé dans app.component.ts
